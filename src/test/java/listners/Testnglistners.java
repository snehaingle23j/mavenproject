...
import testclasses.BasicTest;
import utility.Screenshot;

public class Testnglistners extends BasicTest implements ITestListener

{
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			test.addScreenCaptureFromPath(Screenshot.capturescrshotwithpath(driver, result.getName()));
